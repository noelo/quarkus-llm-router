...
import com.redhat.composer.model.mongo.contentretrieverentites.ElasticConnectionEntity;
...
public interface RetrieverConnectionMapper {
  ...
  /**
   * Maps a ElasticRequest to a ElasticConnectionEntity.
   * 
   * @param request the ElasticRequest to map
   * @return the ElasticConnectionEntity
   */
  ElasticConnectionEntity toEntity(ElasticRequest request);
  ...
  /**
   * Maps a ElasticConnectionEntity to a ElasticRequest.
   * 
   * @param entity the ElasticConnectionEntity to map
   * @return the ElasticRequest
   */
  ElasticRequest toRequest(ElasticConnectionEntity entity);
